-- ============================================
-- YORUMLAR + BİLDİRİMLER - TEK DOSYA
-- ============================================
...
-- Yorum Trigger (DÜZELTİLDİ: v_card.team_id kullanıyor)
...
BEGIN
    -- Kart bilgilerini al (team_id burada)
    ...
    IF v_card.created_by != NEW.user_id THEN
        PERFORM add_notification(
            v_card.team_id,  -- ✅ DÜZELTİLDİ: NEW.team_id → v_card.team_id
            v_card.created_by,
            NEW.card_id,
